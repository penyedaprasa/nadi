                ...
                <div>
                    <div class="col-in row">
                        <!-- <div class="col-md-10 col-sm-10 col-xs-10"> -->
                            <a>NAMA TANAMAN : {{ $a->nama_tanaman }}</a>                    
                    </div>
                   
                    <div class="col-in row">
                        <!-- <div class="col-md-10 col-sm-10 col-xs-10"> -->
                            <a>USIA TANAMAN :  {{ $a->usia_tanaman }} hari</a>
                    </div>
                    <div class="col-in row">
                        <!-- tombol modal -->
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div> 
                                    ...
                                    <br>
                                    <label for="recipient-name" class="right">Min : {{ $a->min_nutrisi }} pH</label>
                                    <br>
                                    <label for="recipient-name" class="right">Max : {{ $a->max_nutrisi }} pH</label>
                                </div>
